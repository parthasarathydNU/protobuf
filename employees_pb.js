...
goog.exportSymbol('proto.Emplyees', null, global);
/**
 ...
 * @constructor
 */
proto.Emplyees = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.Emplyees.repeatedFields_, null);
};
goog.inherits(proto.Emplyees, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.Emplyees.displayName = 'proto.Emplyees';
}
 ...
 * @const
 */
proto.Emplyees.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.Emplyees.prototype.toObject = function(opt_includeInstance) {
  return proto.Emplyees.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.Emplyees} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.Emplyees.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.Emplyees}
 */
proto.Emplyees.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.Emplyees;
  return proto.Emplyees.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.Emplyees} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.Emplyees}
 */
proto.Emplyees.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.Emplyees.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.Emplyees.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.Emplyees} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.Emplyees.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 */
proto.Emplyees.prototype.getEmployeesList = function() {
 ...
 * @return {!proto.Emplyees} returns this
*/
proto.Emplyees.prototype.setEmployeesList = function(value) {
 ...
 * @return {!proto.Employee}
 */
proto.Emplyees.prototype.addEmployees = function(opt_value, opt_index) {
 ...
 * @return {!proto.Emplyees} returns this
 */
proto.Emplyees.prototype.clearEmployeesList = function() {
